...
return function (App $app) {
    ...
    $app->group('/feedback', function (Group $group) {
        $group->get('', [FeedbackController::class, 'getFeedback']);
        $group->get('/admin', [FeedbackController::class, 'getFeedbacks']);
        $group->post('', [FeedbackController::class, 'addFeedback']);
        $group->post('/reply', [FeedbackController::class, 'addReply']);
    })->add(JwtMiddleware::class);
    /**
